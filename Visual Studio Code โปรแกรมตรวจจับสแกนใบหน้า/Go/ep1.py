...
def contact():
    mess._show(title='ผู้พัฒนา', message="นายธนวัฒน์ ปทุมพร 60010912687 BC602 ")
...
frame2 = tk.Frame(window, bg="#708090")
...
datef = tk.Label(frame4, text = " "+day+" "+mont[month]+" "+year+"  |  ", fg="#00FF00",bg="#262523" ,width=55 ,height=1,font=('times', 20, ' bold '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="#00FF00",bg="#262523" ,width=55 ,height=1,font=('times', 22, ' bold '))
...
lbl = tk.Label(frame2, text="รหัส",width=20  ,height=1  ,fg="black"  ,bg="#708090" ,font=('times', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('./angsau_0', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="ชื่อ นามสกุล",width=20  ,fg="black"  ,bg="#708090" ,font=('times', 17, ' bold '))
lbl2.place(x=80, y=140)

txt2 = tk.Entry(frame2, width=32 ,fg="black",font=('Courier', 15, ' bold ')  )
txt2.place(x=30, y=173)

message1 = tk.Label(frame2, text="1)ถ่ายรูป  >>>  2)บันทึกข้อมูล" ,bg="#708090" ,fg="black"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 15, ' bold '))
message1.place(x=7, y=230)

message = tk.Label(frame2, text="" ,bg="#708090" ,fg="black"  ,width=39,height=1, activebackground = "yellow" ,font=('times', 16, ' bold '))
...
takeImg = tk.Button(frame2, text="ถ่ายรูป", command=TakeImages  ,fg="white"  ,bg="#FFA500"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
